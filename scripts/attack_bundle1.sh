#!/usr/bin/env bash
# Bundle 1 - victims trained on OpenBookQA / TREC / ARC-Challenge, calibrated on ARC-Easy.
set -euo pipefail

cd "$(dirname "$0")/.."

MODELS=("llama2" "llama3_1_8b" "mistral7B" "qwen3B" "deepseek_qwen")
EVAL_DATASETS=("openbookqa" "trec" "arc_challenge")
CALIB_DATASET="arc_easy"

NUM_GPUS=4
LOG_DIR="logs/attack_bundle1"
